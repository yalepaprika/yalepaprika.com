    ...
    <article class="stack">
      ...
      <div class="columns">
        <div class="column-left">
          <div class="stack">
            <?php snippet('utilities/detail-list/pages', ['title' => 'Contributors', 'pages' => $page->contributors()->toPages()]) ?>
            <?php snippet('utilities/detail-list/value', ['title' => 'Date', 'value' => $page->formattedDate()]) ?>
            <?php snippet('utilities/detail-list/pages', ['title' => 'Fold', 'pages' => (new Pages())->add($page->parent())]) ?>
          </div>
        </div>
