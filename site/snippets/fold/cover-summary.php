<div
  ...
  class="fold-cover-summary container-xxxl card font--inverted background-paprika space-inside-after-20 space-after-20 <?= $fold->slug() === "rendering-fiction" ||  $fold->slug() === "transient-nostalgia" || $fold->slug() === "transient-intimacy" || $fold->slug() === "transient-solidarity" ? "fold-cover-summary--has-background" : "" ?>"
